...
<head>
    ...
    <link href="{{asset('guest/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/owl.transitions.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/main.css')}}" rel="stylesheet">
    <link href="{{asset('guest/css/responsive.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="js/html5shiv.js"></script>
    <script src="js/respond.min.js"></script>
    <![endif]-->
    <link rel="shortcut icon" href="{{asset('guest/images/ico/favicon.ico')}}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('guest/images/ico/apple-touch-icon-57-precomposed.png')}}">
</head>
<!--/head-->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><h1>{{ config('app.name','laravel')}}</h1></a>
                </div>
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(guest/images/slider/bg1.jpg);">
            ...
            <!--/.item-->
            <div class="item" style="background-image: url(guest/images/slider/bg2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="{{asset('guest/images/main-feature.png')}}" alt="">
                </div>
                <div class="col-sm-6">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                ...
                <img class="img-responsive wow fadeIn" src="{{asset('guest/images/cta2/cta2-img.png')}}" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
            ...
            <div class="portfolio-items">
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('guest/images/portfolio/01.jpg')}}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 1</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="{{asset('guest/images/portfolio/full.jpg')}}" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div>
                <!--/.portfolio-item-->
                ...
                <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('guest/images/portfolio/02.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('guest/images/portfolio/03.jpg')}}" alt="">
                        <div class="portfolio-info">
    ...
    <script src="{{ asset('guest/js/mousescroll.js')}}"></script>
    <script src="{{ asset('guest/js/smoothscroll.js')}}"></script>
    <script src="{{ asset('guest/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{ asset('guest/js/jquery.isotope.min.js')}}"></script>
    <script src="{{ asset('guest/js/jquery.inview.min.js')}}"></script>
